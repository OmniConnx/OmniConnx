	...
	return (
		<div className="landing">
			...
			<div className="hero2">
				<h1>MISSION</h1>
				<p>
					OmniConnx is established to form a global healthcare community <br />{' '}
					through which crowdsourced knowledge will support each other in three
					main areas:{' '}
				</p>
			...
			<div className="hero">
				...
				<div>
					...
					<h2> COMING SOON! </h2>
					<p>
						Through the use of Skills Update, you will be able to <br /> find
